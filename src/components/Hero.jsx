...
/**
 * Wraps children in a motion.div that follows the mouse with smooth
 * spring physics. Different intensity values create layered depth:
 * higher intensity = closer to viewer = more movement.
 */
const ParallaxLayer = ({ children, intensity = 10, className }) => {
  const { translateX, translateY } = useMouseParallax(intensity);
  return (
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div>
            {/* Foreground — heading moves most */}
            <ParallaxLayer intensity={15}>
              <h1
            ...
            {/* Midground — subtitle moves medium */}
            ...
            {/* Background — CTA buttons move least */}
            <ParallaxLayer intensity={4}>
            ...
            {/* Deep background — social links move least */}
            <ParallaxLayer intensity={3}>
